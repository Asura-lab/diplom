...
\begin{enumerate}
    ...
    \item \textbf{Туршилтаар баталгаажуулах}: MetaTrader 5 Strategy Tester-ийн бодит зах зээлийн нөхцөлд (спрэд буюу spread, гулсалт буюу slippage) бэктест (backtest) хийж, системийн ашигт ажиллагааг шинжлэх ухааны аргаар үнэлэх
\end{enumerate}
...
\node[proc] (feat)   at ( 6,  6)   {Техник индикатор};
...
\begin{itemize}
    ...
    \item \textbf{Техник индикатор тооцоолох}: 6 хугацааны интервалаас (M1, M5, M15, M30, H1, H4) тус бүр 8 техник индикатор тооцоолж, нийт 48 техник индикатор үүсгэнэ
...
\toprule
\textbf{№} & \textbf{Техник индикатор} & \textbf{Тайлбар}  \\
\midrule
1 & \texttt{close}      & Тухайн candle-ийн хаалтын үнэ \\
2 & \texttt{rsi}    & RSI (14 candle) --- хэт худалдсан/хэт худалдан авсан байдлыг 0--100 хуваарьт хэмждэг импульс техник индикатор \\
...
Техник индикаторуудыг \texttt{\_1min}, \texttt{\_5min}, \texttt{\_15min}, \texttt{\_30min}, \texttt{\_1H}, \texttt{\_4H} гэсэн дагаваруудаар ялгана. Жишээлбэл, \texttt{rsi\_1min} нь 1 минутын RSI, \texttt{atr\_4H} нь 4 цагийн ATR-ийг илэрхийлнэ. 1 минутын суурь өгөгдлөөс бусад интервалуудын техник индикаторыг \texttt{merge\_asof} (backward) аргаар нэгтгэсэн.
...
\begin{enumerate}
    ...
    \item \textbf{Техник индикатор хялбаржуулалт}: Анхны 75 техник индикатораас 48 болгож бууруулсан. Хэт олон техник индикатор нь загварыг шуугианд суралцуулах эрсдэлтэй
\end{enumerate}
...
\STATE Техник индикатор тооцоолох: $X \gets \text{ComputeFeatures}(D)$ \COMMENT{48 техник индикатор}
...
\node[note=orange!10] at (4,-3.9) {48 техник индикатор тооцоолох};

%% 4. Backend → GBDT
\draw[msg]  (4,-4.8)  -- node[above, font=\small] {Техник индикаторын вектор (48)} (12,-4.8);
...
\node[desc] at (2.6, \dy)     {\textbf{Техник индикатор нэмэх} -- 15 нэмэлт техник индикатор нэмсэн (нийт 63)};
...
\node[desc] at (2.6, 5*\dy)   {\textbf{Overfitting засвар} -- 75$\to$48 техник индикатор. WFV шинжилгээ хийсэн};
