...
\begin{enumerate}
    ...
    \item \textbf{Туршилтаар баталгаажуулах}: MetaTrader 5 Strategy Tester-ийн бодит зах зээлийн нөхцөлд (спрэд буюу spread, гулсалт буюу slippage) түүхэн өгөгдөл дээрх системийн туршилт (backtesting) (backtest) хийж, системийн ашигт ажиллагааг шинжлэх ухааны аргаар үнэлэх
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Backend давхарга}: Flask REST API сервер нь Yahoo Finance-аас бодит цагийн ханш авч, GBDT загвараар дохио үүсгэж, MongoDB-д хадгалж, Expo Push-ээр хэрэглэгчдэд push мэдэгдэл (push notification) илгээнэ
    \item \textbf{Мобайл давхарга}: React Native гар утасны (mobile) аппликейшн нь серверийн хэсэг (Backend)-тэй REST API-аар холбогдож, ханш, дохио, мэдээг хэрэглэгчдэд харуулна
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Хэрэглэгчид хүргэх}: Мобайл аппликейшн нь REST API-аар серверийн хэсэг (Backend)-тэй холбогдож бүх мэдээллийг авна
\end{itemize}
...
\STATE Runtime confidence: $c \gets \max(\bar{P})$
...
\begin{itemize}
    \item \textbf{Итгэлцлийн босго}: Ансамблийн confidence $\geq$ 0.90 (90\%). Загвар 90\%-аас дээш итгэлтэй тохиолдолд л дохио үүсгэнэ
...
\node[note=green!10, minimum width=3.8cm] at (12,-6.0) {LGB + XGB + CatBoost\\Soft Voting confidence};
...
\draw[msg]  (16,-11.2) -- node[above, font=\small] {GET /signals/latest} (4,-11.2);
...
\begin{enumerate}
    ...
    \item Мобайл апп \texttt{GET /signals/latest} хүсэлтээр JSON хариуг авна
\end{enumerate}
...
Загварын болон санхүүгийн системийн гүйцэтгэлийг үнэлэхэд дараахь шалгуур үзүүлэлтүүдийг ашигласан. \tref{tab:eval_metrics} нь тэдгээрийн тодорхойлолт, зорилтот утгыг нэгтгэн харуулав.
...
\midrule
\multicolumn{3}{l}{\textit{Backtest-ийн санхүүгийн үзүүлэлтүүд}} \\
\midrule
Нийт ашиг (\%) & Backtest хугацааны эцсийн хөрөнгийн өсөлт & $>$ 0\% \\
Profit Factor & $\frac{\text{нийт ашиг}}{\text{нийт алдагдал}}$ & $>$ 1.0 \\
Max Алдааны хэлбэлзэл (Drawdown) (\%) & Хамгийн их хөрөнгийн уналтын хувь & $<$ 20\% \\
Win Rate (\%) & Ашигтай санхүүгийн хувь & $\geq$ 40\% \\
Sharpe Ratio & Эрсдэлд тохируулсан өгөөж & $>$ 0.5 \\
\bottomrule
\end{tabular}
\end{table}

Загварын ангиллын нарийвчлал нь санхүүгийн зах зээлийн зах зээл дээр 50\%-аас давахад хэцүү гэдгийг \cite{gu2020empirical} онцолсон тул бидний зорилтот утгыг бага тогтоосон. Гэвч санхүүгийн системд нарийвчлал дангаараа хангалтгүй бөгөөд эрсдэл-өгөөжийн харьцаа (TP:SL = 3:1) нь Win Rate 33\% ч ашигтай байх нөхцөлийг бүрдүүлдэг \cite{pardo2008evaluation}. Иймд backtest-ийн санхүүгийн үзүүлэлтүүд нь загварын бодит ашиг тусыг илүү үнэн зөв илэрхийлнэ.
...
JWT (PyJWT) & -- & Хэрэглэгчийн баталгаажуулалт (iss/aud/exp/iat шалгалттай token) \\
...
\midrule
\multirow{10}{*}{Нэвтрэлт} & \texttt{/auth/register} & POST & Хэрэглэгч бүртгэх \\
& \texttt{/auth/verify-email} & POST & Имэйл баталгаажуулах \\
& \texttt{/auth/login} & POST & Нэвтрэх (JWT token буцаах) \\
& \texttt{/auth/verify} & POST & Access token шалгах \\
& \texttt{/auth/me} & GET & Хэрэглэгчийн мэдээлэл авах \\
& \texttt{/auth/update} & PUT & Профайл шинэчлэх \\
& \texttt{/auth/change-password} & PUT & Нууц үг солих \\
& \texttt{/auth/forgot-password} & POST & Нууц үг сэргээх код илгээх \\
& \texttt{/auth/verify-reset-code} & POST & Reset код баталгаажуулах \\
...
\midrule
\multirow{5}{*}{Дохио} & \texttt{/signal} & GET & Бодит цагийн машин сургалт (machine learning)-ын дохио \\
...
\subsection{Нэвтрэлтийн аюулгүй байдлын бодлого}

Нэвтрэлтийн урсгалд JWT token-ийг богино наст хугацаатайгаар (орчны тохиргоогоор минутын түвшинд) үүсгэж, token шалгалтад \texttt{iss}, \texttt{aud}, \texttt{iat}, \texttt{exp} claim-уудыг заавал баталгаажуулах бодлого хэрэглэсэн. Энэ нь token-ийг буруу орчинд дахин ашиглах болон хугацаа хэтэрсэн token хүлээн зөвшөөрөгдөх эрсдэлийг бууруулдаг.

Нэмэлтээр \texttt{/auth/verify}, \texttt{/auth/update}, \texttt{/auth/change-password}, \texttt{/auth/verify-reset-code} endpoint-уудыг ашиглан сессийн төлөв шалгах, хэрэглэгчийн мэдээлэл шинэчлэх, credential шинэчлэх урсгалыг тусад нь баталгаажуулсан. Ийнхүү authentication хэсэг нь зөвхөн ``нэвтрэх'' үйлдлээс хальж, сессийн бүтэн мөчлөгийг хамгаалсан бүтэцтэй болсон.

\subsection{Серверийн арын процессууд}

Backend сервер нь хэрэглэгчийн хүсэлтүүдийг хүлээн авахаас гадна 4 арын процесс (background thread) тасралтгүй ажиллуулдаг. Олон instance орчинд ижил ажил давхар ажиллах эрсдэлээс сэргийлэхийн тулд runtime\_locks коллекц дээр TTL-тэй distributed lock хэрэглэж, тухайн мөчлөгт зөвхөн нэг эзэмшигч process ажлыг гүйцэтгэх загвар ашигласан:
...
\node[note] at (12,-12.2) {JWT token үүсгэх\\(богино хугацаат, орчноор тохируулна)};
...
Аппликейшн нь React Query сан ашиглан серверийн өгөгдлийг бодит цагийн горимд удирддаг. Ханшийн өгөгдлийг 60 секунд тутам, серверийн төлвийг 30 секунд тутам автоматаар шинэчилдэг. Хөгжүүлэлтийн орчинд локал backend, релизийн орчинд Fly хаяг ашиглах environment-aware API routing хэрэгжүүлснээр орчны endpoint зөрөх эрсдэл буурсан. Алдаа гарсан тохиолдолд retry бодлого хэрэглэж, token хүчингүй үед нэг удаагийн хамгаалалттайгаар сессийн мэдээллийг цэвэрлэн нэвтрэх урсгал руу шилжүүлдэг.
...
\node[desc] at (2.6, 4*\dy)   {\textbf{Алдааны хэлбэлзэл (Drawdown) засвар} -- MaxPositions=1, Risk=1\%. Max DD бууруулсан};
...
\begin{itemize}
    ...
    \item \textbf{Загварын архитектур}: 3 GBDT загварын (LightGBM, XGBoost, CatBoost) Soft Voting ансамблийг Walk-Forward Validation-аар сургаж, calibration-ийг offline үнэлгээнд ашиглан runtime дээр шууд ансамблийн confidence хэрэглэсэн
    ...
    \item \textbf{Системийн хэрэгжүүлэлт}: Flask REST API backend, MongoDB, React Native мобайл аппликейшнийг бүрэн хөгжүүлж, нэвтрэлтийн баталгаажуулалт, distributed lock, орчинд мэдрэг API routing-той end-to-end систем бүтээсэн
