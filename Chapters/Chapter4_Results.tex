...
Сургалт, баталгаажуулалт, тестийн нарийвчлалын ялгааг дангаар нь хэт нийцэл (overfitting) байхгүй гэж шууд дүгнэх боломжгүй. Энэ ажлын хувьд хэт нийцэл (overfitting) эрсдэлийг цаг хугацааны хуваалт буюу урагш гүйлгэн баталгаажуулах (WFV) хуваалт, шинж чанарыг (feature) хялбаршуулах, болон итгэлцэл (confidence) шүүлтүүрийн дараах түүврийн гадуурх (out-of-sample) тогтвортой үзүүлэлтүүдээр хамтатган үнэлсэн. Өөрөөр хэлбэл 87.4\% тестийн нарийвчлал нь зөвхөн нэг тоон дүн бус, 2025 оны түүхэн өгөгдөл дээрх системийн туршилт (backtesting)-ийн өгөөж-эрсдэлийн харьцаатай нийцэж байгаагаар баталгаажсан.
...
XGBoost & L1/L2 нормчлол (regularization) хүчтэй & Хэт нийцэл (overfitting)-аас сайн сэргийлнэ \\
CatBoost & Эрэмбэлэгдсэн нэмэгдүүлэлт (ordered boosting) & Зорилтот хувьсагчийн алдагдал (target leakage)-аас хамгаална \\
\bottomrule
\end{tabular}
\end{table}

\section{Түүхэн өгөгдөл дээрх системийн туршилт (Backtesting)-ийн дүн}

\subsection{Ерөнхий гүйцэтгэл}

2025 оны 01--10 сарын түүхэн өгөгдөл дээрх системийн туршилт (backtesting)-ийн гол хэмжүүрүүдийг \tref{tab:backtest_results} нь харуулав.

\begin{table}[H]
\centering
\caption{MetaTrader 5 түүхэн өгөгдөл дээрх системийн туршилт (backtesting)-ийн дүн (Үе шат (Phase) 7)}
