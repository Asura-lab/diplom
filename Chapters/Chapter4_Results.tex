...
Сургалт, баталгаажуулалт, тестийн нарийвчлалын ялгааг дангаар нь хэт тааруулалт (хэт нийцэл (overfitting)) байхгүй гэж шууд дүгнэх боломжгүй. Энэ ажлын хувьд хэт тааруулалт (хэт нийцэл (overfitting)) эрсдэлийг цаг хугацааны хуваалт буюу урагш гүйлгэн баталгаажуулах (WFV) хуваалт, шинж чанарыг (feature) хялбаршуулах, болон итгэлцэл (confidence) шүүлтүүрийн дараах түүврийн гадуурх (out-of-sample) тогтвортой үзүүлэлтүүдээр хамтатган үнэлсэн. Өөрөөр хэлбэл 87.4\% тестийн нарийвчлал нь зөвхөн нэг тоон дүн бус, 2025 оны түүхэн өгөгдөл дээрх системийн туршилт (backtesting) (backtest)-ийн өгөөж-эрсдэлийн харьцаатай нийцэж байгаагаар баталгаажсан.
...
\midrule
LightGBM & Хурдан, навч чиглэсэн (leaf-wise) өсөлт & Том градиент (gradient)-тэй жишээнд анхаарна \\
XGBoost & L1/L2 нормчлол (regularization) хүчтэй & Хэт тааруулалт (хэт нийцэл (overfitting))-аас сайн сэргийлнэ \\
CatBoost & Эрэмбэлэгдсэн нэмэгдүүлэлт (ordered boosting) & Зорилтот хувьсагчийн алдагдал (target leakage)-аас хамгаална \\
\bottomrule
\end{tabular}
\end{table}

\section{Түүхэн өгөгдөл дээрх системийн туршилт (Backtesting) (Backtest)-ийн дүн}

\subsection{Ерөнхий гүйцэтгэл}

2025 оны 01--10 сарын түүхэн өгөгдөл дээрх системийн туршилт (backtesting) (backtest)-ийн гол хэмжүүрүүдийг \tref{tab:backtest_results} нь харуулав.

\begin{table}[H]
\centering
\caption{MetaTrader 5 түүхэн өгөгдөл дээрх системийн туршилт (backtesting) (backtest)-ийн дүн (Үе шат (Phase) 7)}
\label{tab:backtest_results}
\begin{tabular}{@{} l r @{\qquad} l r @{}}
\toprule
\multicolumn{2}{c}{\textbf{Балансын мэдээлэл}} & \multicolumn{2}{c}{\textbf{Санхүүгийн таамаглалын тоо}} \\
...
\cmidrule(r){1-2} \cmidrule(l){3-4}
Хамгийн их ашиг & \$410.15 & \textbf{Ашгийн хүчин зүйл (Profit Factor)} & \textbf{2.46} \\
Дундаж ашиг & \$351.05 & \textbf{Шарпын харьцаа (Sharpe Ratio)} & \textbf{9.64} \\
Хамгийн их алдагдал & -\$134.67 & \textbf{Нөхөх хүчин зүйл (Recovery Factor)} & \textbf{6.69} \\
Дундаж алдагдал & -\$114.40 & Дундаж хүлээгдэж буй ашиг & \$92.47 \\
 & & \textbf{Хамгийн их уналт (Max DD)} & \textbf{3.93\% (\$530.69)} \\
 & & Хөрөнгийн (Equity) уналт & 5.20\% (\$621.86) \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Хөрөнгийн (Equity) муруй}

\fref{fig:equity_curve} нь 10 сарын хугацаанд балансын тогтвортой өсөлтийг харуулав. Хөрөнгийн (Equity) муруй нь ерөнхийдөө дээшлэх чиглэлтэй, хурц уналтгүй.
...
\end{axis}
\end{tikzpicture}
\caption{Хөрөнгийн (Equity) муруй -- \$10,000-аас \$14,161.20 хүртэл (+41.61\%)}
\label{fig:equity_curve}
\end{figure}

\subsection{Сарын гүйцэтгэл}

\fref{fig:monthly_performance} нь сар бүрийн ашиг ба ашигтай санхүүгийн харьцаа (win rate)-ийг харуулав.
...
\end{axis}
\end{tikzpicture}
\caption{Сарын гүйцэтгэл -- ашиг (\$) ба\\ ашигтай санхүүгийн харьцаа буюу win rate (\%)}
...
\subsection{Уналтын (Алдааны хэлбэлзэл (Drawdown)) шинжилгээ}

\fref{fig:алдааны хэлбэлзэл (drawdown)_chart} нь хөрөнгийн (equity) муруй дээрх уналтын шинжилгээг харуулав.
...
\begin{axis}[
    width=0.95\textwidth,
    height=6cm,
    xlabel={Санхүүгийн таамаглалын дугаар},
    ylabel={Уналт (\%)},
    xmin=0, xmax=46,
    ymin=-5, ymax=0.5,
    grid=major,
...
\end{axis}
\end{tikzpicture}
\caption{Уналтын шинжилгээ (Max Алдааны хэлбэлзэл (Drawdown): 3.93\%)}
\label{fig:алдааны хэлбэлзэл (drawdown)_chart}
\end{figure}

Хамгийн их уналт 3.93\% (\$530.69) байсан нь энэ туршилтын хүрээнд эрсдэлийн бууралт сайжирсныг харуулж байна. Гэхдээ энэхүү үзүүлэлт нь 2025 оны тухайн хугацааны нөхцөлд хэмжигдсэн тул өөр зах зээлийн горимд дахин баталгаажуулах шаардлагатай.
...
Max Алдааны хэлбэлзэл (Drawdown) & 3.93\% & $<$ 10\% & Маш сайн \\
...
\addlegendentry{Confidence мужийн нарийвчлал}
...
Зурагнаас харахад confidence утга нэмэгдэх тусам нарийвчлал мөн нэмэгдэж байгаа нь загварын confidence үнэлгээ монотон шинжтэй байгааг харуулж байна. Энд calibration ойлголтыг runtime дээрх тусдаа calibrator ажиллуулсан гэж бус, ансамблийн магадлалын чанарын шалгалт гэж тайлбарлах нь зүйтэй. 0.92--0.95 мужид 91\%, 0.95-аас дээш 97\% нарийвчлалтай байна.

\subsection{Шинж чанар (Feature)ын ач холбогдол (Feature Importance)}

\fref{fig:feature_importance} нь загварт хамгийн их нөлөөлсөн өгөгдлийн шинж чанаруудыг (features) харуулав.
...
\end{axis}
\end{tikzpicture}
\caption{Шинж чанар (Feature)ын ач холбогдол (Top 20)}
\label{fig:feature_importance}
\end{figure}

Хамгийн чухал өгөгдлийн шинж чанарууд (features)ад:
\begin{itemize}
...
Олон хугацааны хүрээний өгөгдлийн шинж чанарууд (features) (H1, H4) нь M1-ээс илүү ач холбогдолтой байв -- энэ нь ``том зургийг'' (big picture) авч үзэх нь чухал гэдгийг батална.
...
Max Алдааны хэлбэлзэл (Drawdown) & 9.0\% & 3.93\% & -56\% \\
Sharpe Ratio & 4.50 & 9.64 & +114\% \\
\bottomrule
\end{tabular}
\end{table}

Phase 7 нь Phase 6-тэй харьцуулахад эрсдэлийн бүх хэмжүүрээр сайжирсан. Phase 6-д 3,991 дохионоос 121 арилжаа хийж 76.46\% өгөөжтэй байсан ч win rate (37.19\%) бага, алдааны хэлбэлзэл (drawdown) (9\%) өндөр байв. Ялангуяа:
\begin{itemize}
    \item Дохионы чанарыг нэмэгдүүлж (3,991$\to$1,065) санхүүгийн тоог цөөлсөн ч \textbf{чанар эрс сайжирсан}
    \item Win Rate 37.19\%$\to$44.44\%, Алдааны хэлбэлзэл (Drawdown) 56\%-аар буурсан, Sharpe 114\%-аар өссөн
...
\foreach \y/\metric/\old/\new/\change in {
    ...
    -4.2/Max Алдааны хэлбэлзэл (Drawdown)/9.0\%/3.93\%/{\color{green!50!black}$-$56\%},
...
\begin{table}[H]
\centering
\caption{Лавлагааны түвшний нөхцөлт бенчмарк харьцуулалт}
\label{tab:benchmark}
\begin{tabular}{lcccc}
\toprule
...
Жижиглэн эцсийн хэрэглэгчид & -5--+10\% & <1.0 & 20--40\% & 30--40\% \\
\bottomrule
\end{tabular}
\end{table}

Энэ хүснэгт нь яг ижил стратеги, ижил хугацаа, ижил зардлын загвар дээрх шууд one-to-one харьцуулалт биш бөгөөд лавлагааны түвшний чиг баримжаа болгон ашиглагдана. Иймээс ``бүх бенчмаркаас давсан'' гэсэн категорик дүгнэлтээс зайлсхийж, тухайн туршилтын хүрээнд өгөөж-эрсдэлийн харьцаа таатай гарсныг нөхцөлт байдлаар тайлбарлах нь статистикийн хувьд зөв.

\section{Хэт нийцэл (Overfitting) шинжилгээ}

Хөгжүүлэлтийн явцад хэт нийцэл (overfitting) нь нэн чухал сорилт байв. Phase 6-д загвар сургалтын өгөгдөлд маш сайн, тестэд маш муу (win rate 15\%) ажилласан. Энэ асуудлыг шийдсэн арга хэмжээнүүд:

\begin{enumerate}
    \item \textbf{Шинж чанар (Feature) хялбаршуулалт}: 75$\to$48 -- нарийн, чимээ шуугиан бүхий шинж чанар (feature)ыг хассан
...
Хэт нийцэл (Overfitting)-ийн үнэлгээг нэг шалгуурт тулгуурлах бус, дараах хамтарсан нотолгоогоор дүгнэв: (i) time-split WFV дээрх out-of-sample тогтвортой үзүүлэлт, (ii) feature болон загварын хялбаршуулалтын дараах алдааны хэлбэлзэл (drawdown) бууралт, (iii) confidence муж өсөхөд нарийвчлал дагаж өссөн монотон хандлага. Энэ логик нь загварын ерөнхийлөн суралцах чадвар Phase 6-аас Phase 7-д сайжирсныг харуулна.

\section{Operational үр дүн (production орчин)}

Загварын тоон үнэлгээтэй зэрэгцэн системийн бодит ажиллагааг production орчинд баталгаажуулсан. Серверийн хэсэг (backend)-ийг Fly орчинд байршуулж, эрүүл мэндийн endpoint болон runtime төлвийг шалгасан үр дүнг \tref{tab:operational_metrics} харуулав.

\begin{table}[H]
\centering
\caption{Production орчны operational шалгалтын үр дүн}
\label{tab:operational_metrics}
\begin{tabular}{p{5.2cm}p{3.0cm}p{4.8cm}}
\toprule
\textbf{Шалгуур} & \textbf{Ажиглагдсан төлөв} & \textbf{Тайлбар} \\
\midrule
Fly app machine төлөв & Started & Үйлчилгээ тасралтгүй ажиллах төлөв баталгаажсан \\
Health check статус & 1/1 passing & Платформын түвшний тогтвортой ажиллагаа хангагдсан \\
\texttt{/health} endpoint & HTTP 200 & Сервер хариу өгч байгааг баталсан \\
Өгөгдлийн сангийн төлөв & Connected & Health payload-д database холбоос хэвийн \\
Signal generator төлөв & GBDT loaded & Inference хөдөлгүүр ачаалсан төлөв баталгаажсан \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{Машин сургалт (machine learning)-ын дохио}: GBDT ансамбль (Үе шат буюу Phase 7) загварын BUY/SELL/HOLD дохио, итгэлцлийн хувь, SL/TP
    ...
    \item \textbf{Дохионы түүх}: MongoDB-д хадгалагдсан таамаглалны түүх ба статистик
\end{enumerate}
