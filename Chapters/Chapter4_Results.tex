...
Сургалт, баталгаажуулалт, тестийн нарийвчлалын ялгааг дангаар нь хэт тааруулалт (overfitting) байхгүй гэж шууд дүгнэх боломжгүй. Энэ ажлын хувьд хэт тааруулалт (overfitting) эрсдэлийг цаг хугацааны хуваалт буюу урагш гүйлгэн баталгаажуулах (WFV) хуваалт, шинж чанарыг (feature) хялбаршуулах, болон итгэлцэл (confidence) шүүлтүүрийн дараах түүврийн гадуурх (out-of-sample) тогтвортой үзүүлэлтүүдээр хамтатган үнэлсэн. Өөрөөр хэлбэл 87.4\% тестийн нарийвчлал нь зөвхөн нэг тоон дүн бус, 2025 оны бэктест (backtest)-ийн өгөөж-эрсдэлийн харьцаатай нийцэж байгаагаар баталгаажсан.
...
XGBoost & L1/L2 нормчлол (regularization) хүчтэй & Хэт тааруулалт (overfitting)-аас сайн сэргийлнэ \\
CatBoost & Эрэмбэлэгдсэн нэмэгдүүлэлт (ordered boosting) & Зорилтот хувьсагчийн алдагдал (target leakage)-аас хамгаална \\
\bottomrule
\end{tabular}
\end{table}

\section{Бэктест (Backtest)-ийн дүн}

\subsection{Ерөнхий гүйцэтгэл}

2025 оны 01--10 сарын бэктест (backtest)-ийн гол хэмжүүрүүдийг \tref{tab:backtest_results} нь харуулав.

\begin{table}[H]
\centering
\caption{MetaTrader 5 бэктест (backtest)-ийн дүн (Үе шат (Phase) 7)}
...
\fref{fig:monthly_performance} нь сар бүрийн ашиг ба ашигтай арилжааны харьцаа (win rate)-ийг харуулав.
...
\end{axis}
\end{tikzpicture}
\caption{Сарын гүйцэтгэл -- ашиг (\$) ба\\ ашигтай арилжааны харьцаа буюу win rate (\%)}
...
\fref{fig:drawdown_chart} нь хөрөнгийн (equity) муруй дээрх уналтын шинжилгээг харуулав.
...
Олон хугацааны хүрээний техник индикаторууд (H1, H4) нь M1-ээс илүү ач холбогдолтой байв -- энэ нь ``том зургийг'' (big picture) авч үзэх нь чухал гэдгийг батална.
...
\begin{enumerate}
    \item \textbf{Техник индикатор хялбаршуулалт}: 75$\to$48 -- нарийн, чимээ шуугиан бүхий техник индикаторыг хассан
...
Overfitting-ийн үнэлгээг нэг шалгуурт тулгуурлах бус, дараах хамтарсан нотолгоогоор дүгнэв: (i) time-split WFV дээрх out-of-sample тогтвортой үзүүлэлт, (ii) feature болон загварын хялбаршуулалтын дараах drawdown бууралт, (iii) confidence муж өсөхөд нарийвчлал дагаж өссөн монотон хандлага. Энэ логик нь загварын ерөнхийлөн суралцах чадвар Phase 6-аас Phase 7-д сайжирсныг харуулна.
